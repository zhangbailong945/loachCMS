            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#"><i class="fa fa-user fa-fw"></i><font color="blue">{$admin_user}</font>,[{$level_name}]</a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<a href="post.php?action=list" class="btn btn-primary btn-sm {if $list}active{/if}" role="button">文章列表</a>
						<a href="post.php?action=add" class="btn btn-primary btn-sm {if $add}active{/if}" role="button">发表文章</a>
						{if $update}
						<a href="post.php?action=update&id={id}" class="btn btn-primary btn-sm {if $update}active{/if}" role="button">修改文章</a>
						{/if}
                        </div>
                        <!-- /.panel-heading -->
