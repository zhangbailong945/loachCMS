            ...
            <div class="row">
              ...
              <main class="col-md-8 main-content">
				...
				<div class="widget">
					...
					<div class="content community">
                    <embed src="{$templates}/swf/homehomeclock.swf" type="application/x-shockwave-flash" width="100%" height="70px" allowscriptaccess="always" allowfullscreen="true"></embed> 						
					</div>
				</div>
				...
				<div class="widget">
					...
					<div class="content tag-cloud">
			           <a href="">分类(<font color="blue">20</font>)</a>
				...
				<div class="widget">
					...
					<div class="content download">
						<img src="{$templates}/img/gzh.png" width="100%" alt="微信订阅号"/>
					</div>
				</div>
				<!-- end widget -->	
				...
				<div class="widget">
					...
					<div class="content">
				       <a href='ReallySimpleSyndication/rss' target='_blank'>
						<img src='{$templats}/img/rss.gif' width='36' height='14' />
						</a>
				   </div>
				</div>
				<!-- start widget -->
