...
<body>
    ...
    <script src="<?php echo $this->vars['template_admin']; ?>/vendor/raphael/raphael.min.js"></script>
    <script src="<?php echo $this->vars['template_admin']; ?>/vendor/morrisjs/morris.min.js"></script>
