            ...
            <div class="row">
              ...
              <main class="col-md-8 main-content">
				...
				<div class="widget">
					...
					<div class="content community">
                    <embed src="<?php echo $this->vars['templates']; ?>/swf/homehomeclock.swf" type="application/x-shockwave-flash" width="100%" height="70px" allowscriptaccess="always" allowfullscreen="true"></embed> 						
					</div>
				</div>
